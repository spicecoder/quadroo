...
public class LScenes_S  extends QuadRR {

public LScenes_S(QuadRR rr) {
...
//	  int  wi = (new FWord_S (rr)).rwid;
	  	...
	  	ResultSet rsc 	= statement.executeQuery("select name from words ,quadroo where words.wid  = quadroo.sid  AND quadroo.wid=0 AND quadroo.fid = 0;" );
