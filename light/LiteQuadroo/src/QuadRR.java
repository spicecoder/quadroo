...
public class QuadRR extends HttpServlet {
	...
	public QuadRR invokeVerb(String verb) { 
	...
	Class[] argTypes = {clarg};
		...
		return ( (QuadRR)  (ctor.newInstance(this.byD)));
